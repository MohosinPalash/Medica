...
const Footer = () => {
    return (
        <div className="footer">
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-3 col-sm-6 col-xs-12 segment-one md-mb-30 sm-mb-30">
                            <h3>MEDICA</h3>
                            <p className="paragraph">A Renowned Hospital in Bangladesh. We provide 24/7 service across the country. We are always fond of the expert doctors all over the world. We only believe in service nothing else.</p>
            ...
            <p className="footer-bottom-text">All rights reserved by &copy; MEDICA 2021</p>
        </div>
    );
};
